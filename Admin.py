...
l1=Label(root,text="Table of Tickets Booked by Customers:",bg='white',fg='blue')
l1.place(x=10,y=5)
l2=Label(root,text="Table of Tickets Cancelled by Customers:",bg='white',fg='blue')
l2.place(x=1000,y=5)
style=ttk.Style()
...
def delete():
    ...
    com1="delete from payment where ticket_id=:1"
    data2=[(str(e_d2.get()))]
    mycursor.execute(com1,data2)
    mycursor.execute(com,data2)
    mydb.commit()
    mydb.close()
    messagebox.showinfo("Deletion Details","Data has been successfully deleted")
